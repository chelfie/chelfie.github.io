<?php
    ...
    $doc->addStyleSheet('templates/' . $this->template . '/css/style.css'); // Added by: Vincent Smith
	$doc->addStyleSheet('templates/' . $this->template . '/css/footer-style.css'); // Added by: Vincent Smith
	$doc->addStyleSheet('https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.3/css/font-awesome.css'); // Added by: Vincent Smith
	$doc->addStyleSheet('https://fonts.googleapis.com/css?family=Lato'); // Added by: Vincent Smith
